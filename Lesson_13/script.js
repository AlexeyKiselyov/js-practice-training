...
//   return (
//     acc +
//     `<li class='js-product' data-id="${item.id}"><img src="${item.img}" alt="${item.name}" width="100"> <h2 >${item.name} </h2> <p> ${item.price}</p> <button class='js-target'> Купити </button> </li>`
//   );
// }, '');
...
//   const currentProduct = instruments.find(({ id }) => id === Number(currentId));
//   const orderProduct = {
//     date: new Date(),
//     ...currentProduct,
//   };
