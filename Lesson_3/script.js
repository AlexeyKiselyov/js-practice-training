...
// const phones = "89001234567,89001112233,890055566377,890055566378";
...
//
// function consoleNameAndPhone(names, phones) {
//   const namesArr = names.split(",");
//   const phonesArr = phones.split(",");
//   for (let i = 0; i < namesArr.length; i += 1) {
//     if (i < phonesArr.length) {
//       console.log(`${namesArr[i]}: ${phonesArr[i]}`);
//     } else {
//       console.log(`${namesArr[i]}: немає номеру`);
//     }
//   }
// }
// const names = "Jacob,William,Solomon,Kate";
// const phones = "89001234567,89001112233,890055566377б";
// consoleNameAndPhone(names, phones);
...
// const stringChanger = (str) => str.split(" ").slice(1, -1).join(" ");
// console.log(stringChanger(string));
